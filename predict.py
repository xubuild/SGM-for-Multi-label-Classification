...
parser.add_argument('-restore', default='./sgm_rcv1.pt', type=str,
...
testloader = dataloader.get_loader(testset, batch_size=config.batch_size, shuffle=False)
...
def eval(epoch):
    ...
    logging_csv([result['hamming_loss'], result['micro_f1'],
